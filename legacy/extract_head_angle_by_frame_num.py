...
def extract_head_angle(frameIdx, labels_file, plotFlag=False):
    ...
    # _, stim_frames, _ = relevant_frames_from_session_vectorised(octpyMetadata, videoMetadata_list, colorVideoMetadata_list, 10)
    # frame_idx = stim_frames[trial]

    # extract frame
    labels = labels_file
    labeledFrames = labels.labeled_frames
    labeledFrame = labeledFrames[frameIdx]
