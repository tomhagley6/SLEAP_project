...
def test_head_angle_walls_distance(octpy_metadata, trial, stim_frames, labels_file, track_num, plotFlag=False):
    ...
    if plotFlag:
        ...
        ax3.bar(['distance to high', 'distance to low'],[distance_wall_1, distance_wall_2], width=0.5)
        ax3.set_ylim([0,2])
