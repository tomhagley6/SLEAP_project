...
BIN_MAX = 2.00              # x,y max bin values for the heatmap
...
data = {'bias_term':bias_term,
        ...
        'head_angles_wall_1':head_angles_wall_1, 'head_angles_wall_2':head_angles_wall_2}
...
# model trained on all terms, predicting distance on sim data
...
# model trained on distances only, predict distance on sim data
...
# model trained on all but distances_wall_1, predict distance on sim data
...
# model trained on all but distances_wall_2, predict distance on sim data
...
# model trained on only distances_wall_2, predicting distance on sim data
...
# model trained on only distances_wall_1, predicting distance on sim data
...
# model trained on only head_angles_wall_1, head_angles_wall_2, predicting distance on sim data
# (should get nothing here, becuase the model has no information about distance, and is trying to predict
#  choose_high at binned distances only using head angle coefficients)
