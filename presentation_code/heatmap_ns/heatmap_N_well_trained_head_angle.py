from utils.plotting.heatmap_bin_n import heatmap_bin_n
import numpy as np
import pandas as pd
...
# plot heatmap
heatmap_bin_n(df.head_angles_wall_1.values, df.head_angles_wall_2.values, df.chose_high.values, 5,
        bin_max=BIN_MAX, x_title='Head angle High', y_title='Head angle to Low', cut_low_n=True)